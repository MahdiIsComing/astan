...
import ir.upcoders.sheydaee.dummy.DummyContent.DummyItem;
...
//    }
    ...
    public MyShowRecyclerViewAdapter(List<Martyr> martyrs, ShowFragment.OnListFragmentInteractionListener listener) {
        martyrList = martyrs;
        mListener = listener;
